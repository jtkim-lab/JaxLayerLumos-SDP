%This code is used to produce an optimized 3 layer RAM using GA
...
dataFile = 'Total_Thickness_VS_Reflection_3Layer_New.mat';
...
% Setting IntCon constraint so materials and thickness don't mix (4 5 6)
% are thickeness indecies
IntCon = [4 5 6];
...
fileID = fopen('Optimized_Structure_3Layer.txt', 'a'); % Open in append mode
...
fclose(fileID);
disp('Structure appended to Optimized_Structure_3Layer.txt');
...
title('Total Thickness vs. Minimum Reflection for 3 Layer Structure');
grid on;

% Plot the optimized reflection curve
figure;
semilogx(f, rSlab_TE_db, 'r', 'LineWidth', 2.5);
title('Optimized RAM Structure Reflection');
