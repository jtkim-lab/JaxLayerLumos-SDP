...
[rSlab_TE_abs, rSlab_TM_abs] = RMultiSlab_vectorized(nLayers, 0, epsr, mur, f, thicknessMM);
a = rSlab_TE_abs(nLayers+1,:);
rSlab_TE_db = 10 .* log10(a);

thicknessMM2 = [0.975 0.465 0.261 0.432 0.537];
materialInd2 = [13 2 5 8 16];

thicknessMM3 = [0.0009 0.051 0.477 0.636 0.588];
materialInd3 = [2 11 5 6 16];

thicknessMM4 = [0.078 0.411 0.435 0.039 0.273];
materialInd4 = [2 11 5 6 16];

[epsr2, mur2] = initialize_epsr_mur(materialInd2, f)
[epsr3, mur3] = initialize_epsr_mur(materialInd3, f)
[epsr4, mur4] = initialize_epsr_mur(materialInd4, f)

[rSlab_TE_abs2, rSlab_TM_abs2] = RMultiSlab_vectorized(nLayers, 0, epsr2, mur2, f, thicknessMM2);
a2 = rSlab_TE_abs2(length(thicknessMM2)+1,:);
rSlab_TE_db2 = 10 .* log10(a2);

[rSlab_TE_abs3, rSlab_TM_abs3] = RMultiSlab_vectorized(nLayers, 0, epsr3, mur3, f, thicknessMM3);
a3 = rSlab_TE_abs3(length(thicknessMM3)+1,:);
rSlab_TE_db3 = 10 .* log10(a3);

[rSlab_TE_abs4, rSlab_TM_abs4] = RMultiSlab_vectorized(nLayers, 0, epsr4, mur4, f, thicknessMM4);
a4 = rSlab_TE_abs4(length(thicknessMM4)+1,:);
